                    ...
                    {({ processing, errors }) => (
                        <>
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input id="discount_value" name="discount_value" type="number" step="0.01" min="0" required placeholder={discountType === 'percentage' ? '20' : '10.00'} />
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input id="usage_limit" name="usage_limit" type="number" min="1" placeholder="100" />
